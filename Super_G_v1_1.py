...
class window:
    def __init__(self, title = "Super_G", width = 500, height = 500, colour = "black", start_position = [0,0]):
        ...
        self.Super_G_version = "Version 1_1"
...
class entry:
    def __init__(self, window, x, y, width = 10, colour = "black", text_colour = "white"):
        self.window = window
        self.x = x
        self.y = y
        self.width = width
        ...
        self.entry = Entry(self.window.root, bg = self.colour, fg = self.text_colour, width = self.width)
...
if __name__ == '__main__':
    ...
    super_entry = entry(main_window, x = 100, y = 100)
    super_entry.display()
    ...
    main_window.keyboard_trigger("d", lambda p: super_cube.spin_xz(1))
    main_window.keyboard_trigger("a", lambda p: super_cube.spin_xz(-1))
